...
C'est un challenge de cryptographie classique, où on nous donne une implémentation d'un cipher, un ciphertext et il faut comprendre l'implémentation, l'inverser et récupérer le plaintext.
